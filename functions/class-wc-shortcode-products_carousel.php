 ...
 */
class WC_Shortcode_Products_Carousel extends WC_Shortcode_Products {
	...
	protected function product_loop() {
		...
		if ( $products && $products->ids ) {
			...
			woocommerce_product_carousel_loop_start();
			...
			if ( wc_get_loop_prop( 'total' ) ) {
				foreach ( $products->ids as $product_id ) {
					...
					wc_get_template_part( 'custom/content', 'product-carousel' );
			...
			woocommerce_product_carousel_loop_end();
