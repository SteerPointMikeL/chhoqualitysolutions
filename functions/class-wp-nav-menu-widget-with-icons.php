 ...
 * @see WP_Widget
 */
class WP_Nav_Menu_Widget_With_Icons extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'nav_menu_with_icons', __( 'Navigation Menu With Icons' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( 'html5' === $format ) {
			...
			$nav_menu_args = array(
				...
				'walker'               => new SPM_Walker_Nav_Menu_With_Icons,
			);
		} else {
			$nav_menu_args = array(
				'fallback_cb' => '',
...
register_widget( 'WP_Nav_Menu_Widget_With_Icons' );